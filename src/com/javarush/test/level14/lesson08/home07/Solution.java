...
public class Solution
{
    ...
    public static void cleanAllApartaments(List<Apartament> apartaments)
    {
        ...
        for (int i = 0; i < apartaments.size(); i++)
        {
            ...
            if (apartaments.get(i) instanceof Apt2Room) ((Apt2Room) apartaments.get(i)).clean2Rooms();
            if (apartaments.get(i) instanceof Apt3Room) ((Apt3Room) apartaments.get(i)).clean3Rooms();
        }
    }
