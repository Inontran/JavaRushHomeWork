...
5.2. Если параметр равен одной из констант интерфейса Planet, то создать соответствующий объект и присвоить его Planet
...
public class Solution {
    ...
    public static void readKeyFromConsoleAndInitPlanet() {
        ...
        if (parametr.equals(Planet.SUN)) thePlanet = Sun.getInstance();
        if (parametr.equals(Planet.EARTH)) thePlanet = Earth.getInstance();
        if (parametr.equals(Planet.MOON)) thePlanet = Moon.getInstance();
    }
}
