...
public class Space
{
    ...
    public void moveAllItems()
    {
        ...
        for (BaseObject object : getAllItems()) object.move();
    }
    ...
    public List<BaseObject> getAllItems()
    {
        ...
        List<BaseObject> listAllItems = new ArrayList<>();
        listAllItems.addAll(bombs);
        listAllItems.addAll(rockets);
        listAllItems.addAll(ufos);
        listAllItems.add(ship);
        return listAllItems;
    }
    ...
    public void createUfo()
    {
        ...
        if (!ufos.isEmpty()) ufos.add(new Ufo(getWidth()/2, 0));
    }
    ...
    public void checkBombs()
    {
        ...
        for (Bomb bomb : getBombs())
        {
            if (ship.isIntersec(bomb)){
                bomb.die();
                ship.die();
            } else if (bomb.getY() > getHeight()) bomb.die();
        }
    }
    ...
    public void removeDead()
    {
        ...
        while (bombIterator.hasNext()) if ( !bombIterator.next().isAlive() ) bombIterator.remove();

        Iterator<Ufo> ufoIterator = ufos.iterator();
        while (ufoIterator.hasNext()) if ( !ufoIterator.next().isAlive()) ufoIterator.remove();

        Iterator<Rocket> rocketIterator = rockets.iterator();
        while (rocketIterator.hasNext()) if ( !rocketIterator.next().isAlive()) rocketIterator.remove();
    }
